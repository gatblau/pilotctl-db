...
import (
	"context"
	"github.com/gatblau/pilotctl-db/syslog/internal/config"
	"github.com/gatblau/pilotctl-db/syslog/internal/event_store"
	"github.com/gatblau/pilotctl-db/syslog/internal/event_store/db"
	mongo "github.com/gatblau/pilotctl-db/syslog/pkg/mongodb"
	"log"
)
